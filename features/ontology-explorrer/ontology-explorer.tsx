  ...
  return (
    ...
    >
      <div className="shrink-0 border-b border-border px-3 py-3">
        ...
        />
        {/* <div className="mt-3 flex rounded-md border border-border bg-white dark:bg-sidebar">
          <button
            type="button"
            onClick={() => setViewMode("tree")}
            className={cn(
              "flex-1 rounded-l-md px-3 py-2 text-sm font-medium transition-colors",
              viewMode === "tree"
          ...
          <button
            ...
            className={cn(
              "flex-1 rounded-r-md px-3 py-2 text-sm font-medium transition-colors",
              viewMode === "search"
                ? "bg-primary/10 text-primary"
                : "text-text-tertiary hover:text-text-primary"
            )}
